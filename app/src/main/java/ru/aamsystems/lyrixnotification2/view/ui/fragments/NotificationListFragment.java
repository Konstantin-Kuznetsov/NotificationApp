    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ArrayList<? extends LyrixNotification> lyrixNotificationsList
                = new ArrayList<>(Arrays.asList(
                        ...
                        new SimpleLyrixNotification("messageCode3", "messageSource3", "messageCause3", "messageStatus3", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode4", "messageSource4", "messageCause4", "messageStatus4", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode5", "messageSource5", "messageCause5", "messageStatus5", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode6", "messageSource6", "messageCause6", "messageStatus6", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode7", "messageSource7", "messageCause7", "messageStatus7", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode8", "messageSource8", "messageCause8", "messageStatus8", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode9", "messageSource9", "messageCause9", "messageStatus9", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode10", "messageSource10", "messageCause10", "messageStatus10", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode11", "messageSource11", "messageCause11", "messageStatus11", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode12", "messageSource12", "messageCause12", "messageStatus12", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode13", "messageSource13", "messageCause13", "messageStatus13", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode14", "messageSource14", "messageCause14", "messageStatus14", new Date().getTime()),
                        new SimpleLyrixNotification("messageCode15", "messageSource15", "messageCause15", "messageStatus15", new Date().getTime())
        ));
